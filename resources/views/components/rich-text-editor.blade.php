        ...
        <script>
            document.addEventListener('livewire:load', function () {
                ...
                tinymce.init({
                    ...
                    menubar: false,
                    toolbar: 'undo redo | formatselect | bold italic underline link | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | code removeformat | image media',
                    plugins: [
                        'image', 'imagetools', 'table', 'paste', 'wordcount', 'code', 'lists', 'advlist', 'link', 'media'
                    ],
