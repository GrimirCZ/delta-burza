    ...
    <div class="py-12">
        <x-dashboard-card>
            ...
            <p class="mt-4">
                ...
                do jejich on-line schůzek. BurzaŠkol.Online nabízí vždy připojení dopoledne 8:00-12:00, kde můžete se středními školami diskutovat
                ze své základky a potom ten samý den večer 18:00-21:00, kdy můžete vše ještě jednou probrat i se svými rodiči v klidu z domova.
            </p>


            <h3 class="text-xl text-black pt-10 pb-2">Filtr podle vysněného oboru</h3>

            <p class="">
                Jelikož jste na internetovém tržišti a všechna data máme hezky pohromadě, tak nám BurzaŠkol.Online umožňuje i to,
                co normální prezenční výstava neumí. A to například vyfiltrovat pouze ty školy, kde se učí náš vysněný obor.
                Když například budu chtít jít studovat informační technologie v Pardubickém, Královéhradeckém nebo Středočeském kraji,
            ...
            <ul class="marked-list mt-5">
                ...
                <li>A nakonec stisknu tlačítko "Zobrazit školy".</li>
            </ul>


            <p class="mt-5">
                Po jeho stisknutí se zobrazí všechny školy ze zvolených regionů, kde se vyučuje zvolený obor.
                Přímo u škol se zároveň zobrazí termíny a názvy výstav, kterých se škola účastní.
            </p>
            <p class="mt-5">
                Pod školami se zobrazí ještě termíny výstav seřazených dle počtu škol, které vyhovují vašim podmínkám.
            </p>
            <p class="mt-5">
