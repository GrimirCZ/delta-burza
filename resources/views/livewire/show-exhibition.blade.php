    ...
    <div>
        <div class="max-w-7xl mx-auto pt-0 pb-10 px-2 sm:px-6 lg:px-8 w-100">
            <div class="py-10">
                ...
                @else
                    <div class="">
                        <div class="manson-columns">
                            <div class="col-1">
                                @foreach($registrations as $registration)
                                    @if($loop->index%2 == 0)
                                    <div class="manson-item m-3 p-5 shadow-sm box-border h-min-content bg-white {{$registration->school->is_school ?  "border-2 border-teal-400" : ""}}">
