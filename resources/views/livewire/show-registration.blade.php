<div>
    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 w-100">
            ...
            @endphp
            <div class="h-full flex flex-col sm:flex-row justify-around items-center mt-10 sm:mt-32 gap-y-6">
                @foreach($links as $link)
                    <div
                        class="flex flex-col align-center text-center bg-gray-300 sm:px-32 sm:py-16 px-16 py-8 rounded w-3/4 sm:w-auto">
