                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach($selected_exhibitions as $se)
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    @if($is_first_order)
                                        {{number_format(0, 0,",",".")}},- Kč
                                        @php
                                            $is_first_order = false;
                                        @endphp
                                    @else
                                        {{number_format(1000,0,",",".")}},- Kč
                                    @endif
                                </td>
                        ...
                        <tr class="mt-5 border-double border-t-4 border-gray-200">
                            ...
                            <td class="text-right">
                                <button wire:click="add" class="btn btn-primary mt-4 text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="inline-block h-5 mr-2">
