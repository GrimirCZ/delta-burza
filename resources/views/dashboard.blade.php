        ...
        @if(Auth::user()->school_id == null)
            <div
                ...
                <div class="text-center">
                    ...
                    <a href="/spolecnost/vytvorit" class="text-xl btn btn-primary block mt-2">
                        Vložte informace o firmě.
                    </a>
                </div>
            </div>
        @else
            <div class="bg-white shadow overflow-hidden sm:rounded-lg mx-5 mt-10">
                <div class="px-4 py-5 border-b border-gray-200 sm:px-6 flex justify-between">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        Informace o škole
                        <a href="{{$school->is_school ? url("/skola/upravit") : url("/spolecnost/upravit")}}"
                        ...
                        <a href="{{url("/skola/".Auth::user()->school->id)}}" class="text-header ml-4 inline-block">
                            ...
                            <span class="inline-block align-middle">Zobrazit detail školy</span>
                        </a>
                    </h3>
                </div>
                <div>
